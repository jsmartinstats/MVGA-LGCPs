...
% Copied by JSM on 23-01-2017 from ftp://ftp.esat.kuleuven.ac.be/pub/SISTA/markovsky/abstracts/02-115.html
% Edited by JSM on 28-01-2017: output proj indicates that projection to the set of positive semidefinite matrices has happened, i.e. ah has a zero eval

function [ah,ch,sh,proj] = ellipsefit_als(x,ub,tol)
